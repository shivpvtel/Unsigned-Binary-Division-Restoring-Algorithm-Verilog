...
7. Write a report that contains the following: 
  a. Your Verilog design code. Use:
    i. Device: XC7Z010- -1CLG400C or choose any other FPGA type. You can use Arria II if you are using Quartus II software.
  ...
  d. The design schematics from the synthesis of your design. Do not use any area constraints. e. Snapshot of the I/O Planning and
